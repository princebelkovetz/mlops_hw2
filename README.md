...
### 1. Загрузка данных:
 ...
 - В качестве демонстрационного примера можно использовать файл в папке `example` - он специальн подобран так, что в нем много транзакций будут моделью определены как мошеннеческие, и графики в интерфейсе будут более репрезентативными
